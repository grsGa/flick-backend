...
var file_services_user_proto_user_proto_rawDesc = []byte{
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x80, 0x03, 0x0a, 0x0b, 0x55, 0x73, 0x65,
...
var file_services_user_proto_user_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
...
var file_services_user_proto_user_proto_depIdxs = []int32{
	...
	8,  // 9: user.UserService.Register:input_type -> user.RegisterRequest
	10, // 10: user.UserService.Login:input_type -> user.LoginRequest
	1,  // 11: user.UserService.GetUser:input_type -> user.GetUserRequest
	3,  // 12: user.UserService.GetUserByUsername:input_type -> user.GetUserByUsernameRequest
	4,  // 13: user.UserService.UpdateUser:input_type -> user.UpdateUserRequest
	6,  // 14: user.UserService.DeleteUser:input_type -> user.DeleteUserRequest
	9,  // 15: user.UserService.Register:output_type -> user.RegisterResponse
	11, // 16: user.UserService.Login:output_type -> user.LoginResponse
	2,  // 17: user.UserService.GetUser:output_type -> user.GetUserResponse
	2,  // 18: user.UserService.GetUserByUsername:output_type -> user.GetUserResponse
	5,  // 19: user.UserService.UpdateUser:output_type -> user.UpdateUserResponse
	7,  // 20: user.UserService.DeleteUser:output_type -> user.DeleteUserResponse
