...
func main() {
	...
	r.HandleFunc("/api/v1/users/me/avatar", userService.UploadAvatarHandler).Methods("POST", "PUT")
	r.HandleFunc("/api/v1/users/me/cover-image", userService.UploadCoverImageHandler).Methods("POST", "PUT")
