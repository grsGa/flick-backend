...
type ContentRepository interface {
	...
	GetPostByPermalink(ctx context.Context, permalinkID string) (*models.Post, error)
	...
	// 内容媒体相关操作
	SaveContentMedia(ctx context.Context, media *models.ContentMedia) error
	GetContentMediaByID(ctx context.Context, id string) (*models.ContentMedia, error)
	ListUserContentMedia(ctx context.Context, userID string, offset, limit int) ([]*models.ContentMedia, int64, error)
	DeleteContentMedia(ctx context.Context, id string) error
	FindDuplicateMedia(ctx context.Context, userID, mediaType, contentType string, fileSize int64, objectName string) (*models.ContentMedia, error)
}
